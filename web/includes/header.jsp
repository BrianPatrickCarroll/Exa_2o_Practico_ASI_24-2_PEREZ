<%-- 
    Document   : header
    Created on : 14/03/2024, 10:49:36 AM
    Author     : PC-4
--%>
...
<html>
    <head>
        ...
        <title>Administración de empleados Perez Lucas</title>
        <!-----------------------------BOOTSTRAP----------------------------->
        <!--Icono-->
    ...
    <body style="background-color: #9acfea">
        <div class="container">
            <div class="jumbotron">
                <center>
                    <img src="imagenes/logoracle.png" class="img img-responsive" alt="Logo"/>
                    <h3> GESTION DE EMPLEADOS PEREZ</h3>
                </center>
            </div>
        </div>